...
pub const ID_VARIABLE_FUNC_NAME: u32 = 0x001F;
/// The unique identifier for variable `func_call`
pub const ID_VARIABLE_FUNC_CALL: u32 = 0x0020;
/// The unique identifier for variable `funcarg`
pub const ID_VARIABLE_FUNCARG: u32 = 0x0021;
/// The unique identifier for variable `funcargs`
pub const ID_VARIABLE_FUNCARGS: u32 = 0x0022;
/// The unique identifier for variable `dot_call`
pub const ID_VARIABLE_DOT_CALL: u32 = 0x0023;
/// The unique identifier for variable `dot_call_fn`
pub const ID_VARIABLE_DOT_CALL_FN: u32 = 0x0024;
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x001F => visitor.on_variable_func_name(&node),
        0x0020 => visitor.on_variable_func_call(&node),
        0x0021 => visitor.on_variable_funcarg(&node),
        0x0022 => visitor.on_variable_funcargs(&node),
        0x0023 => visitor.on_variable_dot_call(&node),
        0x0024 => visitor.on_variable_dot_call_fn(&node),
