...
const TERMINALS: &[Symbol] = &[
    ...
    Symbol { id: 0x0028, name: "būls" },
    Symbol { id: 0x0029, name: "teksts" },
    Symbol { id: 0x002A, name: "sk" },
    Symbol { id: 0x002B, name: "lsk" },
    Symbol { id: 0x002C, name: "natsk" },
    Symbol { id: 0x002D, name: "lnatsk" },
    ...
    Symbol { id: 0x0041, name: "vai" },
    Symbol { id: 0x0042, name: "un" },
    Symbol { id: 0x0043, name: "ja" },
    Symbol { id: 0x0044, name: "{" },
    Symbol { id: 0x0045, name: "}" },
    Symbol { id: 0x0046, name: "citādi" },
...
pub const ID_VARIABLE_COMP: u32 = 0x001F;
/// The unique identifier for variable if
pub const ID_VARIABLE_IF: u32 = 0x0020;
/// The unique identifier for variable exp_atom
pub const ID_VARIABLE_EXP_ATOM: u32 = 0x0021;
/// The unique identifier for variable exp_reizdal
pub const ID_VARIABLE_EXP_REIZDAL: u32 = 0x0022;
/// The unique identifier for variable exp_plusmin
pub const ID_VARIABLE_EXP_PLUSMIN: u32 = 0x0023;
/// The unique identifier for variable exp
pub const ID_VARIABLE_EXP: u32 = 0x0024;
/// The unique identifier for variable stat
pub const ID_VARIABLE_STAT: u32 = 0x0025;
/// The unique identifier for variable block
pub const ID_VARIABLE_BLOCK: u32 = 0x0026;
/// The unique identifier for variable root
pub const ID_VARIABLE_ROOT: u32 = 0x0027;
...
const VARIABLES: &[Symbol] = &[
    ...
    Symbol { id: 0x001F, name: "comp" },
    Symbol { id: 0x0020, name: "if" },
    Symbol { id: 0x0021, name: "exp_atom" },
    Symbol { id: 0x0022, name: "exp_reizdal" },
    Symbol { id: 0x0023, name: "exp_plusmin" },
    Symbol { id: 0x0024, name: "exp" },
    Symbol { id: 0x0025, name: "stat" },
    Symbol { id: 0x0026, name: "block" },
    Symbol { id: 0x0027, name: "root" },
    Symbol { id: 0x003B, name: "__V59" },
    Symbol { id: 0x004B, name: "__V75" },
    Symbol { id: 0x004C, name: "__VAxiom" }];
...
pub fn visit_ast_node<'a>(node: AstNode<'a>, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x001F => visitor.on_variable_comp(&node),
        0x0020 => visitor.on_variable_if(&node),
        0x0021 => visitor.on_variable_exp_atom(&node),
        0x0022 => visitor.on_variable_exp_reizdal(&node),
        0x0023 => visitor.on_variable_exp_plusmin(&node),
        0x0024 => visitor.on_variable_exp(&node),
        0x0025 => visitor.on_variable_stat(&node),
        0x0026 => visitor.on_variable_block(&node),
        0x0027 => visitor.on_variable_root(&node),
        _ => ()
    };
}
