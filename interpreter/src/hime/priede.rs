...
pub const ID_VARIABLE_BOOL_DEF: u32 = 0x0011;
/// The unique identifier for variable `TEXT`
pub const ID_VARIABLE_TEXT: u32 = 0x0012;
/// The unique identifier for variable `NUM`
pub const ID_VARIABLE_NUM: u32 = 0x0013;
/// The unique identifier for variable `FLOAT`
pub const ID_VARIABLE_FLOAT: u32 = 0x0014;
/// The unique identifier for variable `TYPE`
pub const ID_VARIABLE_TYPE: u32 = 0x0015;
...
pub const ID_VARIABLE_DOTABLE: u32 = 0x002E;
...
pub const ID_VARIABLE_EXP_ATOM: u32 = 0x0030;
...
pub const ID_VARIABLE_EXP_REIZDAL: u32 = 0x0033;
/// The unique identifier for variable `reiz_dal_atl`
pub const ID_VARIABLE_REIZ_DAL_ATL: u32 = 0x0034;
/// The unique identifier for variable `reiz`
pub const ID_VARIABLE_REIZ: u32 = 0x0035;
/// The unique identifier for variable `dal`
pub const ID_VARIABLE_DAL: u32 = 0x0036;
/// The unique identifier for variable `atlik`
pub const ID_VARIABLE_ATLIK: u32 = 0x0037;
/// The unique identifier for variable `exp_plusmin`
pub const ID_VARIABLE_EXP_PLUSMIN: u32 = 0x0038;
/// The unique identifier for variable `plus`
pub const ID_VARIABLE_PLUS: u32 = 0x0039;
/// The unique identifier for variable `minus`
pub const ID_VARIABLE_MINUS: u32 = 0x003A;
/// The unique identifier for variable `exp_t`
pub const ID_VARIABLE_EXP_T: u32 = 0x003B;
/// The unique identifier for variable `exp_a`
pub const ID_VARIABLE_EXP_A: u32 = 0x003C;
/// The unique identifier for variable `xvai`
pub const ID_VARIABLE_XVAI: u32 = 0x003D;
/// The unique identifier for variable `vai`
pub const ID_VARIABLE_VAI: u32 = 0x003E;
/// The unique identifier for variable `un`
pub const ID_VARIABLE_UN: u32 = 0x003F;
/// The unique identifier for variable `exp`
pub const ID_VARIABLE_EXP: u32 = 0x0040;
/// The unique identifier for variable `multiple_ids`
pub const ID_VARIABLE_MULTIPLE_IDS: u32 = 0x0041;
/// The unique identifier for variable `multiple_id_define`
pub const ID_VARIABLE_MULTIPLE_ID_DEFINE: u32 = 0x0042;
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x0011 => visitor.on_variable_bool_def(&node),
        0x0012 => visitor.on_variable_text(&node),
        0x0013 => visitor.on_variable_num(&node),
        0x0014 => visitor.on_variable_float(&node),
        0x0015 => visitor.on_variable_type(&node),
        ...
        0x002E => visitor.on_variable_dotable(&node),
        0x002F => visitor.on_variable_exp_atom_no_dot(&node),
        0x0030 => visitor.on_variable_exp_atom(&node),
        0x0031 => visitor.on_variable_dot_call(&node),
        0x0032 => visitor.on_variable_dot_call_fn(&node),
        0x0033 => visitor.on_variable_exp_reizdal(&node),
        0x0034 => visitor.on_variable_reiz_dal_atl(&node),
        0x0035 => visitor.on_variable_reiz(&node),
        0x0036 => visitor.on_variable_dal(&node),
        0x0037 => visitor.on_variable_atlik(&node),
        0x0038 => visitor.on_variable_exp_plusmin(&node),
        0x0039 => visitor.on_variable_plus(&node),
        0x003A => visitor.on_variable_minus(&node),
        0x003B => visitor.on_variable_exp_t(&node),
        0x003C => visitor.on_variable_exp_a(&node),
        0x003D => visitor.on_variable_xvai(&node),
        0x003E => visitor.on_variable_vai(&node),
        0x003F => visitor.on_variable_un(&node),
        0x0040 => visitor.on_variable_exp(&node),
        0x0041 => visitor.on_variable_multiple_ids(&node),
        0x0042 => visitor.on_variable_multiple_id_define(&node),
