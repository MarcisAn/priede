...
pub const ID_TERMINAL_BREAK: u32 = 0x0014;
/// The unique identifier for terminal CONTINUE
pub const ID_TERMINAL_CONTINUE: u32 = 0x0015;
...
pub const ID_VARIABLE_TRUE: u32 = 0x0016;
/// The unique identifier for variable FALSE
pub const ID_VARIABLE_FALSE: u32 = 0x0017;
/// The unique identifier for variable BOOL
pub const ID_VARIABLE_BOOL: u32 = 0x0018;
/// The unique identifier for variable indexable
pub const ID_VARIABLE_INDEXABLE: u32 = 0x0019;
/// The unique identifier for variable array
pub const ID_VARIABLE_ARRAY: u32 = 0x001A;
/// The unique identifier for variable include_list
pub const ID_VARIABLE_INCLUDE_LIST: u32 = 0x001B;
/// The unique identifier for variable include
pub const ID_VARIABLE_INCLUDE: u32 = 0x001C;
/// The unique identifier for variable array_type
pub const ID_VARIABLE_ARRAY_TYPE: u32 = 0x001D;
/// The unique identifier for variable array_def
pub const ID_VARIABLE_ARRAY_DEF: u32 = 0x001E;
/// The unique identifier for variable var_def
pub const ID_VARIABLE_VAR_DEF: u32 = 0x001F;
/// The unique identifier for variable assign_op
pub const ID_VARIABLE_ASSIGN_OP: u32 = 0x0020;
...
pub const ID_VARIABLE_RETURN_ST: u32 = 0x002F;
...
pub const ID_VARIABLE_EXP_ATOM_SIMPLE: u32 = 0x0031;
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x0014 => visitor.on_terminal_break(&node),
        0x0015 => visitor.on_terminal_continue(&node),
        0x0016 => visitor.on_variable_true(&node),
        0x0017 => visitor.on_variable_false(&node),
        0x0018 => visitor.on_variable_bool(&node),
        0x0019 => visitor.on_variable_indexable(&node),
        0x001A => visitor.on_variable_array(&node),
        0x001B => visitor.on_variable_include_list(&node),
        0x001C => visitor.on_variable_include(&node),
        0x001D => visitor.on_variable_array_type(&node),
        0x001E => visitor.on_variable_array_def(&node),
        0x001F => visitor.on_variable_var_def(&node),
        0x0020 => visitor.on_variable_assign_op(&node),
        ...
        0x002F => visitor.on_variable_return_st(&node),
        0x0030 => visitor.on_variable_exp_atom_no_dot(&node),
        0x0031 => visitor.on_variable_exp_atom_simple(&node),
        0x0032 => visitor.on_variable_dot_call(&node),
        0x0033 => visitor.on_variable_dot_call_fn(&node),
        0x0034 => visitor.on_variable_dotable(&node),
        0x0035 => visitor.on_variable_exp_atom(&node),
        0x0036 => visitor.on_variable_exp_reizdal(&node),
        0x0037 => visitor.on_variable_reiz_dal_atl(&node),
        0x0038 => visitor.on_variable_reiz(&node),
        0x0039 => visitor.on_variable_dal(&node),
        0x003A => visitor.on_variable_atlik(&node),
        0x003B => visitor.on_variable_exp_plusmin(&node),
        0x003C => visitor.on_variable_plus(&node),
        0x003D => visitor.on_variable_minus(&node),
        0x003E => visitor.on_variable_exp_t(&node),
        0x003F => visitor.on_variable_exp_a(&node),
        0x0040 => visitor.on_variable_xvai(&node),
        0x0041 => visitor.on_variable_vai(&node),
        0x0042 => visitor.on_variable_un(&node),
        0x0043 => visitor.on_variable_exp(&node),
        0x0044 => visitor.on_variable_multiple_ids(&node),
        0x0045 => visitor.on_variable_multiple_id_define(&node),
        0x0046 => visitor.on_variable_object_field(&node),
        0x0047 => visitor.on_variable_object_def_field(&node),
        0x0048 => visitor.on_variable_object(&node),
        0x0049 => visitor.on_variable_object_def(&node),
        0x004A => visitor.on_variable_stat(&node),
        0x004B => visitor.on_variable_block(&node),
        0x004C => visitor.on_variable_root(&node),
        _ => ()
    };
}
