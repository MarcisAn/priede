...
pub const ID_VARIABLE_BOOL_DEF: u32 = 0x0012;
/// The unique identifier for variable `TEXT`
pub const ID_VARIABLE_TEXT: u32 = 0x0013;
/// The unique identifier for variable `NUM`
pub const ID_VARIABLE_NUM: u32 = 0x0014;
/// The unique identifier for variable `FLOAT`
pub const ID_VARIABLE_FLOAT: u32 = 0x0015;
/// The unique identifier for variable `TYPE`
pub const ID_VARIABLE_TYPE: u32 = 0x0016;
/// The unique identifier for variable `TRUE`
pub const ID_VARIABLE_TRUE: u32 = 0x0017;
/// The unique identifier for variable `FALSE`
pub const ID_VARIABLE_FALSE: u32 = 0x0018;
/// The unique identifier for variable `BOOL`
pub const ID_VARIABLE_BOOL: u32 = 0x0019;
...
pub const ID_VARIABLE_ARRAY_DEF_VALUE: u32 = 0x001E;
/// The unique identifier for variable `var_def_value`
pub const ID_VARIABLE_VAR_DEF_VALUE: u32 = 0x001F;
/// The unique identifier for variable `asignable_exp`
pub const ID_VARIABLE_ASIGNABLE_EXP: u32 = 0x0020;
/// The unique identifier for variable `assign_op`
pub const ID_VARIABLE_ASSIGN_OP: u32 = 0x0021;
/// The unique identifier for variable `id_assign`
pub const ID_VARIABLE_ID_ASSIGN: u32 = 0x0022;
/// The unique identifier for variable `array_assign`
pub const ID_VARIABLE_ARRAY_ASSIGN: u32 = 0x0023;
/// The unique identifier for variable `func_name`
pub const ID_VARIABLE_FUNC_NAME: u32 = 0x0024;
/// The unique identifier for variable `func_call`
pub const ID_VARIABLE_FUNC_CALL: u32 = 0x0025;
/// The unique identifier for variable `funcarg`
pub const ID_VARIABLE_FUNCARG: u32 = 0x0026;
/// The unique identifier for variable `funcargs`
pub const ID_VARIABLE_FUNCARGS: u32 = 0x0027;
/// The unique identifier for variable `comp_s`
pub const ID_VARIABLE_COMP_S: u32 = 0x0028;
/// The unique identifier for variable `if`
pub const ID_VARIABLE_IF: u32 = 0x0029;
/// The unique identifier for variable `s_loop`
pub const ID_VARIABLE_S_LOOP: u32 = 0x002A;
/// The unique identifier for variable `w_loop`
pub const ID_VARIABLE_W_LOOP: u32 = 0x002B;
/// The unique identifier for variable `arg`
pub const ID_VARIABLE_ARG: u32 = 0x002C;
/// The unique identifier for variable `func_def_args`
pub const ID_VARIABLE_FUNC_DEF_ARGS: u32 = 0x002D;
...
pub const ID_VARIABLE_DOTABLE: u32 = 0x0030;
/// The unique identifier for variable `exp_atom_no_dot`
pub const ID_VARIABLE_EXP_ATOM_NO_DOT: u32 = 0x0031;
/// The unique identifier for variable `exp_atom`
pub const ID_VARIABLE_EXP_ATOM: u32 = 0x0032;
/// The unique identifier for variable `dot_call`
pub const ID_VARIABLE_DOT_CALL: u32 = 0x0033;
/// The unique identifier for variable `dot_call_fn`
pub const ID_VARIABLE_DOT_CALL_FN: u32 = 0x0034;
...
pub const ID_VARIABLE_STAT: u32 = 0x0045;
/// The unique identifier for variable `block`
pub const ID_VARIABLE_BLOCK: u32 = 0x0046;
/// The unique identifier for variable `root`
pub const ID_VARIABLE_ROOT: u32 = 0x0047;
...
pub fn visit_ast_node(node: AstNode, visitor: &dyn Visitor) {
    ...
    match node.get_symbol().id {
        ...
        0x0012 => visitor.on_variable_bool_def(&node),
        0x0013 => visitor.on_variable_text(&node),
        0x0014 => visitor.on_variable_num(&node),
        0x0015 => visitor.on_variable_float(&node),
        0x0016 => visitor.on_variable_type(&node),
        0x0017 => visitor.on_variable_true(&node),
        0x0018 => visitor.on_variable_false(&node),
        0x0019 => visitor.on_variable_bool(&node),
        ...
        0x001E => visitor.on_variable_array_def_value(&node),
        0x001F => visitor.on_variable_var_def_value(&node),
        0x0020 => visitor.on_variable_asignable_exp(&node),
        0x0021 => visitor.on_variable_assign_op(&node),
        0x0022 => visitor.on_variable_id_assign(&node),
        0x0023 => visitor.on_variable_array_assign(&node),
        0x0024 => visitor.on_variable_func_name(&node),
        0x0025 => visitor.on_variable_func_call(&node),
        0x0026 => visitor.on_variable_funcarg(&node),
        0x0027 => visitor.on_variable_funcargs(&node),
        0x0028 => visitor.on_variable_comp_s(&node),
        0x0029 => visitor.on_variable_if(&node),
        0x002A => visitor.on_variable_s_loop(&node),
        0x002B => visitor.on_variable_w_loop(&node),
        0x002C => visitor.on_variable_arg(&node),
        0x002D => visitor.on_variable_func_def_args(&node),
        0x002E => visitor.on_variable_func_def(&node),
        0x002F => visitor.on_variable_return_st(&node),
        0x0030 => visitor.on_variable_dotable(&node),
        0x0031 => visitor.on_variable_exp_atom_no_dot(&node),
        0x0032 => visitor.on_variable_exp_atom(&node),
        0x0033 => visitor.on_variable_dot_call(&node),
        0x0034 => visitor.on_variable_dot_call_fn(&node),
        ...
        0x0045 => visitor.on_variable_stat(&node),
        0x0046 => visitor.on_variable_block(&node),
        0x0047 => visitor.on_variable_root(&node),
        _ => ()
    };
}
